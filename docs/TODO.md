...
| routes/index.js | 81 | check email verified middleware
...
| public/javascripts/bundle/chat_bundle.js | 962 | quick hack, since no viewmodel currently holds votes
| public/javascripts/bundle/chat_bundle.js | 1044 | this is ratchet as fuck omg
...
| routes/index.js | 67 | test this extensively
| routes/index.js | 69 | set confirmed to true in both cache and database
| routes/index.js | 73 | render some error page
...
| app/authentication/user-pass.js | 159 | add stronger password checker
| app/authentication/user-pass.js | 161 | less lazy error message lmao
...
| public/javascripts/bundle/chat_bundle.js | 1028 | refactor joinRoom in voteview to a super class or something
