...
| app/search/search_info_generate.js | 28 | generate index and types for user data
| app/search/search_manager.js | 43 | error handle
| app/search/search_manager.js | 54 | add suggestions to body
| app/sockets/chatSocket.js | 76 | find a way to cache this
| app/sockets/chatSocket.js | 87 | refactor back into above method, quick hack
...
| routes/chats/chats.js | 106 | include error message to pass to view
| routes/chats/chats.js | 137 | find a way to test this, since we are resetting members every time in the test
| routes/chats/chats.js | 152 | include error message to pass to view
| routes/chats/chats.js | 217 | use microservice
...
| public/javascripts/bundle/home_bundle.js | 84 | ajax call to server
| public/javascripts/bundle/home_bundle.js | 92 | some error message here
| public/javascripts/bundle/home_bundle.js | 95 | some success here
| public/javascripts/bundle/home_bundle.js | 98 | already a member
| public/javascripts/bundle/home_bundle.js | 312 | organize this using some frontend framework
...
| test/models.js | 209 | for some reason this test does not work well with others
...
| app/sockets/chatSocket.js | 73 | violates open close principle
...
| public/javascripts/bundle/home_bundle.js | 398 | quick hack, since no viewmodel currently holds votes
